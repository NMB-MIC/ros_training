...
def program1():
    client_feedback.JointMovJ(0,0,20,77,0,0)
    
def program2():
    client_feedback.JointMovJ(0,16,53,77,0,0)

def program3():
    client_feedback.JointMovJ(0,35,43,77,0,0)

def program4():
    client_feedback.JointMovJ(0,30,10,77,0,0)
    
try:
    while(not rospy.is_shutdown()) and dobot_Enable == True:    
        client_dashboard.SpeedJ(25)     
        program1()
        time.sleep(1)
        program2()
        time.sleep(1)
